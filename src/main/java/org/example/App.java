...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        writeBaseDateTextDocument(posts);
        System.out.println("Все полученные посты: ");
        readBaseDateTextDocument();
    }


    private static void writeBaseDateTextDocument(List<Post> list) throws IOException {

        ManagerTextDocument managerTextDocument = new ManagerTextDocument(list);
        managerTextDocument.write();
    }
    private static void readBaseDateTextDocument(){
        ManagerTextDocument managerTextDocument = new ManagerTextDocument();
        managerTextDocument.read();
    }
}